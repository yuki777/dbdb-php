        ...
        switch ($action) {
            ...
            case 'create-start':
                if (empty($name) || empty($version) || empty($port)) {
                    ...
                    $output->writeln('e.g.');
                    $output->writeln("composer dbdb:" . self::SERVICE . " $action --db-name=my-redis-6 --db-version=6.0.16 --db-port=6379");
                    $output->writeln("composer dbdb:" . self::SERVICE . " $action --db-name=my-redis-random --db-version=6.2.6 --db-port=random");
